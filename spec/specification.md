...
<p class="calendar-summary">I have posted <span class="calendar-post-count">X posts</span> and <span class="calendar-note-count">Y notes</span> so far, and have posted every week for the last <span class="calendar-streak-count">N weeks</span>.</p>
<div class="calendar">
...
- The `..., and have posted every week for the last N weeks` clause (with its `.calendar-streak-count` span) is omitted entirely — not just left with `N=0` — when there's no current streak.
